...
export default function PilihanSuratComp({ route, navigation }) {
  ...
  <body style="width: 21cm; height: 29.7cm">
    <div style="border-bottom: 2px solid black; position: relative">
      ...
      <div style="padding: 10; margin: 2; text-align: center">
        ...
        <h5 style="margin: 2; padding: 0; font-size: x-small">No : ${data.nospk}</h5>
        <h5 style="margin: 2; padding: 0; font-size: x-small">Proyek : ${data.judul}</h5>
        <h5 style="margin: 2; padding: 0; font-size: x-small">Alamat : ${data.alamat}</h5>
      </div>
    </div>
            ...
            <table border="0" cellpadding="1" style="width: 200px">
              <tbody>
                <tr>
                  ...
                  <td width="200"><span style="font-size: x-small; font-weight: bold;">${data.tembusan}</span></td>
                </tr>
                <tr>
                  <td><span style="font-size: x-small">Up.</span></td>
                  <td><span style="font-size: x-small">:</span></td>
                  <td><span style="font-size: x-small; font-weight: bold;">${data.tembusan}</span></td>
                </tr>
              </tbody>
            </table>
          </td>
            ...
            <table border="0" cellpadding="1" style="width: 200px">
              <tbody>
                <tr>
                  ...
                  <td width="8"><span style="font-size: x-small">:</span></td>
                  <td width="200"><span style="font-size: x-small">${data.alamat}</span></td>
                </tr>
                <tr>
                  <td><span style="font-size: x-small">Kota</span></td>
                  <td><span style="font-size: x-small">:</span></td>
                  <td><span style="font-size: x-small">${data.kota}</span></td>
                </tr>
                <tr>
                  <td><span style="font-size: x-small">Telp</span></td>
                  <td><span style="font-size: x-small">:</span></td>
                  <td><span style="font-size: x-small">${data.telptemb}</span></td>
                </tr>
              </tbody>
            </table>
          </td>
    ...
    <p style="font-size: x-small; margin-top: 2; margin-bottom: 2; text-align: justify; margin-bottom: 10;">
      Menunjuk penawaran dari ${data.penerima} terkait pekerjaan ${data.judul}, bersama ini kami menugaskan ${data.penerima}, berdomisili di ${data.kota}, untuk melaksanakan Pekerjaan ${data.judul},
      yang berlokasi di ${data.alamat}.
    </p>
    <div>
      <tr>
        <td colspan="2">
          <table border="0" cellpadding="1" style="width: 21cm">
            <tbody>
              ...
              <tr>
                ...
                <td colspan="2" width="200"><span style="font-size: x-small">Harga ${data.judul} di ${data.alamat} adalah dengan total nilai ${convertRupiah.convert(
      detail.reduce((sum, i) => (sum += i.jumlah * i.harga), 0)
    )},- (${toTitleCase(angkaTerbilang(detail.reduce((sum, i) => (sum += i.jumlah * i.harga), 0)))} Rupiah)</span></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td colspan="2" width="200" style="padding-top: 3">
                  <span style="font-size: x-small">Pelaksanaan Pekerjaan ${data.judul} di ${data.alamat}  adalah sesuai dengan penawaran dari Penerima Tugas dengan spesifikasi sebagai berikut :</span>
                </td>
              </tr>
            </tbody>
          </table>
              ...
              <tr>
                ...
                <td colspan="2" width="200" style="padding-top: 3">
                  <span style="font-size: x-small; text-align: justify;"
                    >Pelaksanaan Pekerjaan terhitung sejak SPK ditandatangani oleh kedua belah pihak dan lama pengerjaan terhitung ${data.estimasi}. ${data.judul} di ${
      data.alamat
        ...
        <td colspan="2">
          <table border="0" cellpadding="1" style="width: 21cm">
            <tbody>
              ...
              <tr>
                <td width="10"><span style="font-size: x-small; font-weight: bold"></span></td>
                <td style="padding-top: 3" colspan="2" width="200"><span style="font-size: x-small">${data.pembayaran}</span></td>
              </tr>
              <tr>
              ...
              <tr>
              <td width="10"><span style="font-size: x-small; font-weight: bold"></span></td>
              <td style="padding-top: 3" colspan="2" width="200"><span style="font-size: x-small">${data.lain}</span></td>
            </tr>
            </tbody>
          </table>
        </td>
    ...
    <p style="font-size: x-small; margin-top: 2; margin-bottom: 2; text-align: justify;margin-top: 10;">
      Menunjuk ${data.penerima} terkait pekerjaan ${data.judul}, bersama ini kami menugaskan ${data.penerima}, berdomisili di ${data.kota}, untuk melaksanakan Pekerjaan ${data.judul},
      yang berlokasi di ${data.alamat}.
    </p>
            ...
            <table border="0" cellpadding="1" style="width: 21cm; text-align: center;">
              <tbody>
                <tr>
                  ...
                  <td width="200"><span style="font-size: x-small;font-weight: bold;">Bali, ${ubahTanggal(data.tanggal)}</span></td>
                </tr>
                <tr>
        ...
        <tr>
          <td colspan="2">
            <table border="0" cellpadding="1" style="width: 21cm; text-align: center;">
              <tbody>
                <tr>
                  <td width="200"><span style="font-size: x-small; font-weight: bold;">${data.pemberi}</span></td>
                  <td width="600"><span style="font-size: x-small"></span></td>
                  <td width="200"><span style="font-size: x-small; font-weight: bold;">${data.penerima}</span></td>
                </tr>
  ...
  return (
    <TailwindProvider>
      <ScrollView>
        <View>
          <View style={styles.container} className="justify-between pl-4 pr-2 pt-4 pb-2">
            ...
            <Text className=" bg-white rounded-md w-2/4 pl-4 py-1">{data.nospk}</Text>
          </View>

          <View style={styles.container} className="justify-between pl-4 pr-2 pb-2">
            <Text style={styles.input}>Judul Proyek</Text>
            <Text className=" bg-white rounded-md w-2/4 pl-4 py-1">{data.judul}</Text>
          </View>

          <View style={styles.container} className="justify-between pl-4 pr-2 pb-2">
            <Text style={styles.input}>Penerima Tugas</Text>
            <Text className=" bg-white rounded-md w-2/4 pl-4 py-1">{data.penerima}</Text>
          </View>

          <View style={styles.container} className="justify-between pl-4 pr-2 pb-2">
            <Text style={styles.input}>Alamat Proyek</Text>
            <Text className=" bg-white rounded-md w-2/4 pl-4 py-1">{data.alamat}</Text>
          </View>
          <View style={styles.container} className="justify-between pl-4 pr-2 pb-2">
            <Text style={styles.input}>Kota</Text>
            <Text className=" bg-white rounded-md w-2/4 pl-4 py-1">{data.kota}</Text>
          </View>

          <View style={styles.container} className="justify-between pl-4 pr-2 pb-2">
            <Text style={styles.input}>Tanggal</Text>
            <Text className=" bg-white rounded-md w-2/4 pl-4 py-1">{ubahTanggal(data.tanggal)}</Text>
          </View>

          <View style={styles.container} className="justify-between pl-4 pr-2 pb-2">
            <Text style={styles.input}>Estimasi Pekerjaan</Text>
            <Text className=" bg-white rounded-md w-2/4 pl-4 py-1">{data.estimasi}</Text>
          </View>

          <View style={styles.container} className="justify-between pl-4 pr-2 pb-2">
            <Text style={styles.input}>Terms Pembayaran</Text>
            <Text className=" bg-white rounded-md w-2/4 pl-4 py-1">{data.pembayaran}</Text>
          </View>
          <View style={styles.container} className="justify-between pl-4 pr-2 pb-2">
            <Text style={styles.input}>Lain - Lain</Text>
            <Text className=" bg-white rounded-md w-2/4 pl-4 py-1">{data.lain}</Text>
          </View>
          <View style={styles.container} className="justify-between pl-4 pr-2 pb-2">
            <Text style={styles.input}>Pemberi Tugas</Text>
            <Text className=" bg-white rounded-md w-2/4 pl-4 py-1">{data.pemberi}</Text>
          </View>
        </View>
      ...
      <View style={{ flexDirection: "row" }}>
        <ButtonComp title="CETAK" classNa="bg-zinc-500 py-4 active:bg-zinc-700 rounded-none flex-1" onPress={createPDF} />
        <ButtonComp title="HAPUS" classNa="bg-red-500 py-4 active:bg-red-700 rounded-none flex-1" onPress={hapusLaporan} />
      </View>
    </TailwindProvider>
  );
}
